...
if not uploaded:
    ...
    pattern = r"@mndl\.bio|test|sella\.rafaeli|talia\.rapoport04|nony\.ux|elanitleiter|eugenia\.vovk|kfir@shapira|dharmender@zangula|eranmilddf|talimiller|username\.com|elanit2@yopmail\.com|elanit@yopmail\.com|muteeb285@gmail\.com|muteebworkinfo@gmail\.com"
